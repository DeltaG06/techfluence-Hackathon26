...
from engine.models import Alert, PatternFlag
...
def build_alert(
    ...
    return Alert(
        ...
        # executive_summary filled later by summary_layer for HIGH/CRITICAL only
    )
...
def _compute_severity(
    ...
    if anomaly_score > 0.70 or has_high_flag or multi_flag:
        return "HIGH"
