...
import { ShieldAlert, LayoutDashboard, TrendingUp, Moon, Sun, Settings, User } from 'lucide-react';
      ...
      <div className="px-4 pt-4 pb-0 flex-shrink-0 z-40">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            {/* User card — opaque card/button look */}
            <div
              className="flex items-center gap-2.5 pl-2.5 pr-4 py-2 rounded-xl cursor-pointer transition-all duration-200 hover:brightness-110 active:scale-95"
              style={{
            ...
            >
              <div className="w-7 h-7 rounded-full bg-white/20 border border-white/40 flex items-center justify-center flex-shrink-0">
                <User className="w-4 h-4 text-white" />
              </div>
              <div>
                <p className="text-xs font-semibold text-white leading-tight">Janardan</p>
                <p className="text-[9px] font-semibold text-amber-50 leading-tight">Risk Analyst</p>
              </div>
            </div>
          </div>
        </div>
