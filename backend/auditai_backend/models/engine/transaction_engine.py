...
# Suppress cosmetic sklearn warning: scaler fitted with DataFrame column names
# but scored with numpy array — computation is identical, warning is noise.
...
PROJECT     = HERE.parent.parent             # …/auditai-backend/
